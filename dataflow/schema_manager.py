...
class SchemaManager:
    ...
    def build_model_class(cls, schema_obj) -> Type[models.Model]:
        ...
        attrs: Dict[str, Any] = {
            '__module__': 'dataflow.schema_manager',
            'objects': Manager(),
        }
    ...
    def register_model(cls, model_class: Type[models.Model]) -> None:
        ...
        if key in apps.all_models.get('dataflow', {}):
            return
        apps.all_models.setdefault('dataflow', {})[key] = model_class
        apps.clear_cache()
    ...
    def get_model_for_dataset(cls, dataset_id: int) -> Optional[Type[models.Model]]:
        ...
        return apps.all_models.get('dataflow', {}).get(key)
    ...
    def register_all_on_startup(cls) -> None:
        ...
        for schema_obj in schemas:
            try:
                ...
                logger.warning("Skipping broken schema for dataset %s (%s): %s",
                              schema_obj.dataset_id, schema_obj.table_name, exc)
